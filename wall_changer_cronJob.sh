...
#shopt -s nullglob
PWD=/home/buddika/WallpaperChanger
...
#echo $wallpaper_path
#echo "index is $index"
echo "Executing script at $(date). Wallpaper index: $index. Path: $wallpaper_path" >> $PWD/../cronFile.log
echo "Executing script at $(date). Wallpaper index: $index. Path: $wallpaper_path"
######### END OF DEBUGGING ##########
